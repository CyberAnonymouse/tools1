#grabber Tools Dddos Tembus Jetz By Runher
import random
import socket
import threading
import socket
...
os.system('cls')
print('Tools Tembus Anti Ddos Jetx By Runher')
password = 'Runher'
for i in range(3):
    pwd = input('Account : ')
    j = 3
...
time.sleep(5)
os.system('cls')
print(" \033[92m Tools By : Runher Carder")
print("\033[0m")
print(""" \033[91m 
...
print(" ⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉ ")
print(" ➤ CREATED BY Runher Carder")
print(" ➤ Tembus Anti Ddos By Jetx")
print(" ⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉⑉ ")
...
time.sleep(3)
print(" Done Now The Server Has Been Get Anti DDoS... Just Wait...")
time.sleep(5)
